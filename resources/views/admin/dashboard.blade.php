...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const trainerChart = new Chart(ctx3, {
        type: 'bar', // you can also use 'pie' or 'doughnut'
        data: {
            labels: {!! json_encode($trainerNames) !!},
            datasets: [{
                label: 'Courses Uploaded',
                data: {!! json_encode($trainerCounts) !!},
                backgroundColor: [
                    'rgba(54, 162, 235, 0.7)',
                    'rgba(255, 99, 132, 0.7)',
                    'rgba(255, 206, 86, 0.7)',
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4" style="height: 470px;">
                                ...
                                <div class="chart">
                                    ...
                                    <canvas id="enrollmentChart" style="height: 250px !important;"></canvas>
                                   <script>
    document.addEventListener('DOMContentLoaded', function () {
